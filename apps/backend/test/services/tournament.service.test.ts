...
describe('Tournament generator', () => {
	describe('Generatepools', () => {
		test('GeneratePools should return 1 pools with size 7 when given 7 players', () => {
			...
			const players: Player[] = [
				...
				{ firstName: 'Lesley', lastName: 'Stam',matchPoints: 0,setPoints: 0,totalScoredPoints: 0},
				{ firstName: 'Joe', lastName: 'Johnsson',matchPoints: 0,setPoints: 0,totalScoredPoints: 0},
				{ firstName: 'Brigit', lastName: 'van der Plas',matchPoints: 0,setPoints: 0,totalScoredPoints: 0},
				{ firstName: 'Norbert', lastName: 'Pennings',matchPoints: 0,setPoints: 0,totalScoredPoints: 0},
				{ firstName: 'Bob', lastName: 'van Mierlo',matchPoints: 0,setPoints: 0,totalScoredPoints: 0},
			]
		...
		test('GeneratePools should return 2 pools with 1 having 5 and 1 having 6 when given 11 players', () => {
			...
			const players: Player[] = [
				...
				{ firstName: 'Norbert', lastName: 'Pennings',matchPoints: 0,setPoints: 0,totalScoredPoints: 0},
				{ firstName: 'Bob', lastName: 'van Mierlo',matchPoints: 0,setPoints: 0,totalScoredPoints: 0},
				{ firstName: 'Wilco', lastName: 'van Es',matchPoints: 0,setPoints: 0,totalScoredPoints: 0},
				{ firstName: 'Stijn', lastName: 'van Houwelingen',matchPoints: 0,setPoints: 0,totalScoredPoints: 0},
				{ firstName: 'Else', lastName: 'van der Kooij',matchPoints: 0,setPoints: 0,totalScoredPoints: 0},
				{ firstName: 'Menno', lastName: 'Schepers',matchPoints: 0,setPoints: 0,totalScoredPoints: 0},
			]
			//Act
			const sut = tournamentGenerator.generatePools(players)
			//Assert
		...
		test('GeneratePools should return 3 pools with 1 having 4, 2 having 5 and 3 having 5 when given 14 players', () => {
			...
			const players: Player[] = [
				...
				{ firstName: 'Else', lastName: 'van der Kooij', matchPoints: 0,setPoints: 0,totalScoredPoints: 0 },
				{ firstName: 'Menno', lastName: 'Schepers', matchPoints: 0,setPoints: 0,totalScoredPoints: 0 },
				{ firstName: 'Ton', lastName: 'van der Ende', matchPoints: 0,setPoints: 0,totalScoredPoints: 0 },
				{ firstName: 'Berend', lastName: 'Nijenhuis', matchPoints: 0,setPoints: 0,totalScoredPoints: 0 },
				{ firstName: 'Natalia', lastName: 'Nijboer', matchPoints: 0,setPoints: 0,totalScoredPoints: 0 },
			]
	...
	describe('GenerateQueue', () => {
		test('GenerateQueue should return 1 queue ', () => {
			...
			//Assert 2
			expect(queueArray[0]).toStrictEqual({ player1: { firstName: 'Stijn', lastName: 'van Houwelingen', matchPoints: 0,setPoints: 0,totalScoredPoints: 0 } as Player, player2: { firstName: 'Menno', lastName: 'Schepers', matchPoints: 0,setPoints: 0,totalScoredPoints: 0 } as Player } as Match)
